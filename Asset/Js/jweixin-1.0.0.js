...
var weixin = function () {
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            MynonceStr = data.NonceStr;
            Mysignature = data.Signature;
            MyappId = data.AppID;
            wx.config({
                debug: false,
                appId: MyappId,
    ...
    wx.ready(function () {
        wx.onMenuShareTimeline({//朋友圈
            ...
            trigger: function (res) {
                this.link = "https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx83446c48d46752c5&redirect_uri=http%3A%2F%2Fufirefly.com%2Fh5%2Fssss%2Fdefault.html%3Fname%3D"+encodeURI(wxName)+"%26score%3D"+indexTime+"%26type%3D1&response_type=code&scope=snsapi_userinfo&state=STATE&connect_redirect=1#wechat_redirect";
                this.imgUrl = shareImg;
